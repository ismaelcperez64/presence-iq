    ...
    <main className="min-h-screen bg-brand-dark px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-slate-400">Everything the audit found — documented, scored, and prioritized into one actionable PDF.</p>
        </div>
        ...
        <div className="rounded-2xl border border-brand-cyan/30 bg-brand-cyan/5 p-6 mb-6">
        ...
        <a href="/" className="block mt-8 text-center text-sm text-slate-600 hover:text-slate-400 transition-colors">← Back to audit</a>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-brand-card border border-brand-border rounded-2xl max-w-lg w-full p-6 sm:p-8 shadow-2xl">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-black text-white mb-2">Skip the DIY — Let Us Build It For You</h2>
            ...
            <ul className="space-y-2 mb-6">
              {['Everything in the Full Report', 'FB, YouTube & LinkedIn profiles created', 'AI-generated profile content', 'Monthly lead automation system', 'Dedicated account manager'].map(f => (
            ...
            <button onClick={() => goToPayment(true)}
            ...
            <button onClick={() => goToPayment(false)}
